...
export const ICONS = {
  ...
  BackOfNote: getIconAsJSX("text-select"),
  Reload: getIconAsJSX("rotate-ccw"),
  Copy: getIconAsJSX("copy"),
  Globe: getIconAsJSX("globe"),
  Crop: getIconAsJSX("crop"),
  Bookmark: getIconAsJSX("bookmark"),
  Camera: getIconAsJSX("camera"),
  ZoomToSelectedElement: getIconAsJSX("scan"),
  Properties: getIconAsJSX("settings"),
  ZoomToSection: getIconAsJSX("hash"),
  ZoomToBlock: (
    <svg
  ...
  insertImage: getIconAsJSX("image"),
  insertMD: getIconAsJSX("file-text"),
  insertLaTeX: getIconAsJSX("sigma"),
  insertLink: getIconAsJSX("link"),
  search: getIconAsJSX("search"),
  ocr: (
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
           viewBox="0 0 24 24" fill="none" stroke="var(--icon-fill-color)"
           strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"
           className="svg-icon lucide-scan-line-2">
        <path d="M3 7V5a2 2 0 0 1 2-2h2M17 3h2a2 2 0 0 1 2 2v2M21 17v2a2 2 0 0 1-2 2h-2M7 21H5a2 2 0 0 1-2-2v-2M7.5,17l4.05,-9.7a.5,.5 0 0 1 .9,0l4.05,9.7M8.8,14h6.4" />
      </svg>
  ),
  scriptEngine: (
      <svg
  ...
  openLink: getIconAsJSX("file-symlink"),
  openLinkProperties: getIconAsJSX("file-code"),
  ...
  gotoFullScreen: getIconAsJSX("maximize"),
  exitFullScreen: getIconAsJSX("minimize"),
  releaseNotes: getIconAsJSX("megaphone"),
  rawMode: getIconAsJSX("code-xml"),
  parsedMode: getIconAsJSX("glasses"),
  convertFile: (
    <svg
      aria-hidden="true"
      focusable="false"
  ...
  cog: getIconAsJSX("settings"),
  copyElementLink: (
      <svg className="svg-icon lucide-vector-square-link" width="24" height="24" fill="none" stroke="var(--icon-fill-color)"
        ...
        <path d="m17 5v-2c0-0.554 0.446-1 1-1h3c0.554 0 1 0.446 1 1v3c0 0.554-0.446 1-1 1h-2"/>
        <path d="m7 19v2c0 0.554-0.446 1-1 1h-3c-0.554 0-1-0.446-1-1v-3c0-0.554 0.446-1 1-1h2"/>
        <rect x="2" y="2" width="5" height="5" rx="1"/>
        <path d="m13.041 15.135-0.58926 0.58926c-2.9856 2.9856-7.2282-1.2571-4.2426-4.2426l0.58926-0.58926M10.92 8.7708m0.49474-0.49474c2.9856-2.9856 7.2282 1.2571 4.2426 4.2426l-0.49474 0.49474M10.213 13.721 l3.5355-3.5355"/>
      </svg>
  ),
  importSVG: getIconAsJSX("file-input"),
  obsidian: (
    <svg
      //aria-hidden="true"
      focusable="false"
  ...
  "add-file": getIconAsJSX("file-plus"),
  tray: getIconAsJSX("monitor-cog"),
};
...
export const saveIcon = (isDirty: boolean) => {
  return (
    <svg 
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      className="svg-icon lucide-save"
    >
